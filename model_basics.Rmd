...
The type of mathematical model we'll talk about in this book are functions. There are other types of mathematical models that aren't functions, but we're not going to cover those in this book. 
...
[Anscombe's quartet](https://en.wikipedia.org/wiki/Anscombe%27s_quartet) is a set of four small data sets. The data sets have very similar descriptive statistics, but are visually very different. In this section, we'll use a modified version of the first data set in the quartet. 
