...
This chapter focuses on the first step. Using `diamonds`, we'll explore the relationship between `price` and the 4 Cs: `carat`, `clarity`, `color`, and `cut`. By the end of the chapter, we'll understand which function family or families might approximate the data well. 
