...
* The price follows a power law with an exponent of `r a_1`. Since the exponent is greater than 1, price growth is faster than linear. This means that as a the price of a diamond increases, the cost of adding an additional 0.1 carat will also increase. For example, buying a 0.6 carat instead of a 0.5 carat diamond will cost you `r scales::dollar(price_diff_small, accuracy = 1)` more, but buying a 2.1 carat instead of a 2.0 carat will cost you `r scales::dollar(price_diff_large, accuracy = 1)` more.
