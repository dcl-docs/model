...
Building a model requires sufficient data, and there are so few diamonds above 2.5 carats that they are barely visible in the histogram. So we will restrict our attention to most of our diamonds and not the outliers, which could distort some models. In particular, we'll limit our data so that we only include 99% of the diamonds and ignore the largest 1%.
